...
$sql = "SELECT Product_item.*, Product_category.Class_name FROM Product_item INNER JOIN Product_category ON Product_item.Category_id = Product_category.Id";
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="shop-details.html"><i class="fa fa-heart"></i> <span>1</span></a></li>
...
<section class="featured spad">
            ...
            <div class="col-lg-12">
                ...
                <div class="featured__controls">
                    <ul>
                        ...
                        <li data-filter=".vegie">Vegetables</li>
                        <li data-filter=".vegetables">Fruits</li>
                        <li data-filter=".fastfood">Milk & Diary</li>
    ...
    $price = $row['Price'];
    $class_name = $row['Class_name']; // Get the class name from the query result;

    // Display the product in a HTML element
    echo "<div class='col-lg-3 col-md-4 col-sm-6 mix $class_name' style='background-color:white'>"; // Use the class name in the div element
    echo "<div class='featured__item'>";
    echo "<div class='featured__item__pic set-bg' data-setbg='$image_path'>"; // Use the data-setbg attribute to set the image source
    echo "</div>";
    echo "<div class='featured__item__text'>";
    echo "<h6><a href=\"product.php?id=" . $row["Id"] . "\">$name</a></h6>"; // Display the product name with a link to edit page
    echo "<h5>$$price</h5>"; // Display the product price
    echo "</div>";
    echo "</div>";
    echo "</div>";
    }  ?>
