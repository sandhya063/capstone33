...
#Profile {
  /* Set the width of the div element to 50% of the parent element */
  width: 50%;
  /* Set the left and right margins to auto to center the div element */
  margin-left: auto;
  margin-right: auto;
...
if (isset($_SESSION['user_id'])) {
    ...
    // query the user table to get the user details
    $sql = "SELECT FName, LName, Phone_no, Type, gender FROM User WHERE Id = '$user_id'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div id=\"Profile\">";
        // display the user details as a screen output with proper labels
        echo "<h2>Profile</h2>";
    ...
    // user is not logged in, redirect back to the login form or display an error message
    echo "<p id=\"error\">Please log in first.</p>";
}
    echo"</div>";
